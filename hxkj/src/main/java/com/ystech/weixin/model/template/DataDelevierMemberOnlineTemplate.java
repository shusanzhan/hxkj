 ...
 *
 */
public class DataDelevierMemberOnlineTemplate {
    ...
    private DataMemberOnline data; //详细内容
	...
	public DataMemberOnline getData() {
		return data;
	}

	public void setData(DataMemberOnline data) {
		this.data = data;
	}
